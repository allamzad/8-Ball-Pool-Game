 ...
 *
 * @param v the vector whose unit vector is desired
 * @return the unit vector of v
 */
vector_t vec_unit(vector_t v);

/**
 * Returns the projection of a vector onto a line.
 *
 * @param v the vector whose projection is desired
 * @param line the line the vector is being projected onto
 * @return the projection of v onto the line
 */
